...
// Test 1: Path whitelist for open (PHP5 uses open syscall, not openat)
echo "Test 1: Path whitelist for open\n";
echo "-------------------------------------\n";
echo "[*] Config: open only allowed for /tmp/ and /etc/\n";
...
syscall_filter_begin([
    ...
    'open' => ['/tmp/', '/etc/'],  // Path whitelist (PHP5 uses open)
]);
...
echo "\n========================================\n";
echo "Test 2: No path constraint for open\n";
echo "========================================\n";
echo "[*] Config: open with empty array [] (no path constraint)\n";
...
syscall_filter_begin([
    ...
    'close' => [],
    'fstat' => [],
    'open' => [],  // Empty array = no path constraint
]);
...
// Test open with /tmp/ (should succeed)
echo "\n[*] Testing open with /tmp/ path\n";
...
echo "========================================\n";
echo "[*] Config: open allowed for /tmp/ prefix\n";
